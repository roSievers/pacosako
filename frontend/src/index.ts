...
// Create a websocket where game updates can be received.

const socket = io("http://localhost:3001");

socket.on("connection", (data: any) => console.log(data));

socket.on("boardSaved", (data: any) => {
  console.log(data);
  onLoadSuccess(JSON.parse(data));
});
